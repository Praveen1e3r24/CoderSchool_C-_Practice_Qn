//Part 1
//Write a C# program that concatenates two strings and then outputs the result.
...
//Part 2
//Modify the program so that it gets the two strings from the user.
...
//Part 3
//Modify the program so that it concatenates three strings instead of two.
//Hint: You can use the + operator to concatenate three strings.
//Hint: You can use the Console.WriteLine() method to output the result.


//Part 4
//Modify the program to concatenate a string and an integer.
