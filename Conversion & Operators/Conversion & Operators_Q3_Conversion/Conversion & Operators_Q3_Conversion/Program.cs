...
//In a game, the player's progress is stored as a boolean (true for completed, false for incomplete), but you need to display it as a string ("Completed" or "Incomplete"). Convert the player's progress from a boolean to a string representing the status and print the result.
